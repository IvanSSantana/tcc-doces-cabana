...
> **Ordem executada:** `002` → `003` → `001` → `004` → `005`. A `001`
...
> cadastrar administradores, reaproveitando a compensação da `004`.
>
> **Próxima:** `006`, que valida tudo pela interface via Playwright.
