...
que a `012` declarou impossível até a `020` registrar pedidos, e que aparece
...
- **RN-02** — Um título de seção só afirma o que o sistema sabe. "Mais
  vendidos" volta a ser um título possível quando a `020` registrar pedidos —
...
- **Fazer "Mais vendidos" funcionar.** Depende da `020`, que registra pedidos.
